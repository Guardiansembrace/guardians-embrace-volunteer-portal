...
async def add_member(
    ...
    try:
        ...
        import logging
        logging.getLogger(__name__).warning("Failed to send member_added notification", exc_info=True)
...
async def remove_member(
    ...
    if removed_user:
        try:
            ...
            import logging
            logging.getLogger(__name__).warning("Failed to send member_removed notification", exc_info=True)
