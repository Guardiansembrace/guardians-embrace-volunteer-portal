...
class ProjectWorkItem(BaseDocument):
...
class ProjectWorkItemResponse(BaseModel):
    ...
    @field_validator("assignee_ids", "assignee_names", "checklist", "activity_log", "watcher_ids", "blocked_by_ids", mode="before")
    @classmethod
    def coerce_null_list_to_empty(cls, value: object) -> object:
