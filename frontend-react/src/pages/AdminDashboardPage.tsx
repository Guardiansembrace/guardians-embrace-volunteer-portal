...
import { Button, GuidancePanel, LoadingSpinner, InfoTooltip } from '../components/ui';
import {
    ArrowRight,
    BellRing,
    Users,
                ...
                <div className="container" style={{ padding: '2.5rem 1rem', maxWidth: '1200px', margin: '0 auto' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '1.5rem', marginBottom: '3rem' }}>
                        <div>
                            ...
                            <h1 style={{ margin: '0', fontSize: '1.75rem', fontWeight: 700, color: '#0f172a', letterSpacing: '-0.02em', lineHeight: 1.2 }}>
                                Command Center
                            </h1>
                            <p style={{ margin: '0.75rem 0 0', color: '#64748b', fontSize: '0.9rem', maxWidth: '550px', lineHeight: 1.5 }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem', marginBottom: '4rem' }}>
                                {stats?.submissions && (
                                    <>
                                        ...
                                        info="Issues reported by volunteers that require immediate admin intervention"
                                    />
                                        <AdminMetric
                                            title="Drafts Open"
                                            ...
                                            info="Updates started by volunteers but not yet finalized"
                                        />
                                        <AdminMetric
                                            ...
                                            info="Updates successfully submitted by the team"
                                        />
                                    </>
                                )}
                                {stats?.users && (
                                    <AdminMetric
                                        ...
                                        info="Users who haven't logged in recently"
                                    />
                                )}
                                <AdminMetric
                                    ...
                                    info="Project workspaces currently active and accepting work items"
                                />
                            </div>

                            {/* Workspaces Grid */}
                            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
                                <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#0f172a', margin: 0, letterSpacing: '-0.01em' }}>Core Workspaces</h2>
                            </div>
                            ...
                            {canViewAuditLogs && (
                                <div style={{ marginTop: '3rem' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem', gap: '1rem', flexWrap: 'wrap' }}>
                                        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, color: '#0f172a', margin: 0, letterSpacing: '-0.01em' }}>Recent Audit Activity</h2>
                                        <Link
                                            to="/admin/audit"
                                            style={{
    ...
    const card = (
        ...
        onMouseOut={(event) => {
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
                <p style={{ margin: 0, fontSize: '0.8rem', fontWeight: 700, color: tone === 'default' ? '#475569' : style.iconColor, textTransform: 'uppercase', letterSpacing: '0.06em', display: 'flex', alignItems: 'center' }}>
                    {title}
            ...
            <div>
                <h3 style={{ margin: 0, fontSize: '1.75rem', fontWeight: 700, color: style.color, lineHeight: 1, letterSpacing: '-0.02em' }}>
                    {value}
                </h3>
        ...
        <Link to={href} style={{ textDecoration: 'none', display: 'block', height: '100%' }}>
            ...
            onMouseOut={(e) => {
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.25rem' }}>
                    ...
                    <h3 style={{ margin: 0, fontSize: '1.2rem', fontWeight: 700, color: '#0f172a', letterSpacing: '-0.01em' }}>{title}</h3>
                </div>
