...
import { Button, LoadingSpinner, InfoTooltip } from '../components/ui';
        ...
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{
                ...
                <Button
                    ...
                    style={{ padding: '1rem 2.5rem', fontSize: '1rem', marginBottom: '1rem' }}
                >
            ...
            <div style={{ background: 'var(--color-bg-secondary)', padding: '4rem 1rem' }}>
                <div className="container">
                    ...
                    <div className="grid grid-cols-4" style={{ maxWidth: '1000px', margin: '0 auto' }}>
                        <FeatureCard icon={<FileText size={32} />} title="Submit Updates" description="Log your weekly work, hours, and progress" info="Fill out a simple form to share your progress" />
                        <FeatureCard icon={<Clock size={32} />} title="Track Hours" description="Monitor your volunteer hours over time" info="Automatically tally your contributions for reporting" />
                        <FeatureCard icon={<Users size={32} />} title="Stay Connected" description="Communicate with leadership" info="Share blockers and get help from the team lead" />
                        <FeatureCard icon={<Shield size={32} />} title="Make Impact" description="See how your work contributes" info="Your updates keep the mission moving forward" />
                    </div>
                </div>
            </div>
...
function FeatureCard({ icon, title, description, info }: { icon: React.ReactNode; title: string; description: string; info?: string }) {
    return (
        <div style={{
            background: 'white',
            padding: '2rem',
            ...
            <h3 style={{ fontSize: '1.1rem', fontWeight: 600, marginBottom: '0.5rem', color: 'var(--color-text-primary)', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                {title}
