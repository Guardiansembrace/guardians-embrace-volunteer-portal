...
export function Navbar() {
    const { user, isAdmin, logout, setName } = useAuth();
    ...
    return (
        <header className="navbar-wrapper">
                        ...
                        <div className="relative" ref={dropdownRef} style={{ position: 'relative' }}>
                            ...
                            >
                                <div className="text-right hidden-mobile">
                                    ...
                                    <div style={{ fontSize: '0.75rem', opacity: 0.8, color: 'var(--color-dark-bg)', marginTop: '-2px' }}>{isAdmin ? 'Administrator' : 'Volunteer'}</div>
                                </div>
                            ...
                            {isDropdownOpen && (
                                <div style={{
                                    ...
                                    <div style={{ padding: '0.5rem' }}>
                                        {isEditingName ? (
                                            <div style={{ padding: '0.5rem' }}>
                                                <label style={{ display: 'block', fontSize: '0.75rem', fontWeight: 600, marginBottom: '0.5rem', color: 'var(--color-text-secondary)' }}>Update Full Name</label>
                                                <input
                                                    value={editNameValue}
            ...
            <div style={{ background: 'var(--color-dark-bg)', padding: '0' }}>
                <div className="container flex items-center justify-between">
